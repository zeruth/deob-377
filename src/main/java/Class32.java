...
public final class Class32 {
	...
	public static String method371( Class10_Sub1_Sub3 arg0, int arg1) {
		try {
			int local3 = 0;
			int local5 = -1;
			int local18;
			for ( int local7 = 0; local7 < arg1; local7++) {
				int local12 = arg0.method311();
	...
	public static void method372( String arg0, Class10_Sub1_Sub3 arg1) {
		try {
			if (arg0.length() > 80) {
	...
	public static String method373( String arg0) {
		try {
			...
			int local9 = aClass10_Sub1_Sub3_2.anInt428;
			aClass10_Sub1_Sub3_2.anInt428 = 0;
