...
public final class Class8 {
	...
	public static void method17( Class33_Sub1 arg0, Packet arg1) {
		try {
			int local7 = -1;
			while (true) {
	...
	public void method16( int arg0, int arg1, byte[] arg2, int arg3, int arg4, int arg5, Class47[] arg6, int arg7, int arg8) {
		try {
			...
			Packet local62 = new Packet(arg2);
				...
				if (arg7 == 10 || arg7 == 11) {
					...
					if (local162 != null) {
						...
						if (arg0.method200(arg3, local260, arg2, local162, local133, local247, arg4, local263, local94, local109) && local97.aBoolean190) {
							Model local294;
							if (local162 instanceof Model) {
								local294 = (Model) local162;
							} else {
	...
	public void method22( int arg0, int arg1, int arg2, byte[] arg3, int arg4, Class47[] arg5) {
		try {
			...
			Packet local70 = new Packet(arg3);
	...
	private void method31(int arg0, int arg1, Packet arg2, int arg3, int arg4, int arg5, int arg6) {
		try {
			int local34;
