...
public final class Class17 {
	...
	private static Class10_Sub1_Sub3 aClass10_Sub1_Sub3_1;
	...
	public static Class17 method104( int arg0) {
		...
		aClass10_Sub1_Sub3_1.anInt428 = anIntArray52[arg0];
	...
	public static void method106( Class2 arg0) {
		aClass10_Sub1_Sub3_1 = new Class10_Sub1_Sub3(true, arg0.method2("obj.dat", null));
		Class10_Sub1_Sub3 local19 = new Class10_Sub1_Sub3(true, arg0.method2("obj.idx", null));
		anInt179 = local19.method313();
		anIntArray52 = new int[anInt179];
		int local27 = 2;
		for ( int local29 = 0; local29 < anInt179; local29++) {
			anIntArray52[local29] = local27;
			local27 += local19.method313();
		}
	...
	public static Class10_Sub1_Sub1_Sub1 method113( int arg0, int arg1, int arg2) {
		try {
			Class10_Sub1_Sub1_Sub1 local9;
			if (arg0 == 0) {
				local9 = (Class10_Sub1_Sub1_Sub1) aClass34_4.method387((long) arg2);
				if (local9 != null && local9.anInt109 != arg1 && local9.anInt109 != -1) {
					local9.method534();
					local9 = null;
				}
				if (local9 != null) {
			...
			Class10_Sub1_Sub1_Sub1 local80 = null;
			...
			local9 = new Class10_Sub1_Sub1_Sub1(32, 32);
			...
			for ( int local202 = 31; local202 >= 0; local202--) {
				for (local176 = 31; local176 >= 0; local176--) {
					if (local9.anIntArray37[local202 + local176 * 32] == 0) {
						if (local202 > 0 && local9.anIntArray37[local202 + local176 * 32 - 1] > 1) {
							local9.anIntArray37[local202 + local176 * 32] = 1;
						} else if (local176 > 0 && local9.anIntArray37[local202 + (local176 - 1) * 32] > 1) {
							local9.anIntArray37[local202 + local176 * 32] = 1;
						} else if (local202 < 31 && local9.anIntArray37[local202 + local176 * 32 + 1] > 1) {
							local9.anIntArray37[local202 + local176 * 32] = 1;
						} else if (local176 < 31 && local9.anIntArray37[local202 + (local176 + 1) * 32] > 1) {
							local9.anIntArray37[local202 + local176 * 32] = 1;
						}
					}
				}
			...
			if (arg0 > 0) {
				for (local327 = 31; local327 >= 0; local327--) {
					for (local176 = 31; local176 >= 0; local176--) {
						if (local9.anIntArray37[local327 + local176 * 32] == 0) {
							if (local327 > 0 && local9.anIntArray37[local327 + local176 * 32 - 1] == 1) {
								local9.anIntArray37[local327 + local176 * 32] = arg0;
							} else if (local176 > 0 && local9.anIntArray37[local327 + (local176 - 1) * 32] == 1) {
								local9.anIntArray37[local327 + local176 * 32] = arg0;
							} else if (local327 < 31 && local9.anIntArray37[local327 + local176 * 32 + 1] == 1) {
								local9.anIntArray37[local327 + local176 * 32] = arg0;
							} else if (local176 < 31 && local9.anIntArray37[local327 + (local176 + 1) * 32] == 1) {
								local9.anIntArray37[local327 + local176 * 32] = arg0;
							}
						}
					}
				...
				for (local327 = 31; local327 >= 0; local327--) {
					for (local176 = 31; local176 >= 0; local176--) {
						if (local9.anIntArray37[local327 + local176 * 32] == 0 && local327 > 0 && local176 > 0 && local9.anIntArray37[local327 + (local176 - 1) * 32 - 1] > 0) {
							local9.anIntArray37[local327 + local176 * 32] = 3153952;
						}
					}
				}
			}
			if (local30.anInt182 != -1) {
				local327 = local80.anInt108;
				int local511 = local80.anInt109;
				local80.anInt108 = 32;
				local80.anInt109 = 32;
				local80.method78(0, 0);
				local80.anInt108 = local327;
				local80.anInt109 = local511;
			}
			if (arg0 == 0) {
	...
	private void method110( byte arg0, Class10_Sub1_Sub3 arg1) {
		try {
			if (arg0 != 6) {
				this.aBoolean50 = !this.aBoolean50;
			}
			while (true) {
				while (true) {
					int local15 = arg1.method311();
					if (local15 == 0) {
						return;
					}
					if (local15 == 1) {
						this.anInt193 = arg1.method313();
					} else if (local15 == 2) {
						this.aString7 = arg1.method318();
					} else if (local15 == 3) {
						this.aByteArray8 = arg1.method319();
					} else if (local15 == 4) {
						this.anInt200 = arg1.method313();
					} else if (local15 == 5) {
						this.anInt192 = arg1.method313();
					} else if (local15 == 6) {
						this.anInt189 = arg1.method313();
					} else if (local15 == 7) {
						this.anInt174 = arg1.method313();
						if (this.anInt174 > 32767) {
							this.anInt174 -= 65536;
						}
					} else if (local15 == 8) {
						this.anInt181 = arg1.method313();
						if (this.anInt181 > 32767) {
							this.anInt181 -= 65536;
						}
					} else if (local15 == 10) {
						this.anInt202 = arg1.method313();
					} else if (local15 == 11) {
						this.aBoolean52 = true;
					} else if (local15 == 12) {
						...
						this.anInt186 = arg1.method313();
						this.aByte14 = arg1.method312();
					} else if (local15 == 24) {
						this.anInt175 = arg1.method313();
					} else if (local15 == 25) {
						this.anInt173 = arg1.method313();
						this.aByte12 = arg1.method312();
					} else if (local15 == 26) {
						this.anInt188 = arg1.method313();
						...
						int local257 = arg1.method311();
						this.anIntArray53 = new int[local257];
						this.anIntArray51 = new int[local257];
						for ( int local267 = 0; local267 < local257; local267++) {
							this.anIntArray53[local267] = arg1.method313();
							this.anIntArray51[local267] = arg1.method313();
						}
					} else if (local15 == 78) {
						this.anInt201 = arg1.method313();
					} else if (local15 == 79) {
						this.anInt198 = arg1.method313();
					} else if (local15 == 90) {
						this.anInt178 = arg1.method313();
					} else if (local15 == 91) {
						this.anInt203 = arg1.method313();
					} else if (local15 == 92) {
						this.anInt194 = arg1.method313();
					} else if (local15 == 93) {
						this.anInt195 = arg1.method313();
					} else if (local15 == 95) {
						this.anInt180 = arg1.method313();
					} else if (local15 == 97) {
						this.anInt177 = arg1.method313();
					} else if (local15 == 98) {
						this.anInt182 = arg1.method313();
					} else if (local15 >= 100 && local15 < 110) {
						if (this.anIntArray54 == null) {
							this.anIntArray54 = new int[10];
							this.anIntArray55 = new int[10];
						}
						this.anIntArray54[local15 - 100] = arg1.method313();
						this.anIntArray55[local15 - 100] = arg1.method313();
					} else if (local15 == 110) {
						this.anInt197 = arg1.method313();
					} else if (local15 == 111) {
						this.anInt190 = arg1.method313();
					} else if (local15 == 112) {
						this.anInt199 = arg1.method313();
					} else if (local15 == 113) {
						this.anInt187 = arg1.method312();
					} else if (local15 == 114) {
						this.anInt191 = arg1.method312() * 5;
					} else if (local15 == 115) {
						this.anInt176 = arg1.method311();
					}
				}
			}
