...
public final class Class33_Sub1 extends Class33 implements Runnable {
	...
	public void method564( Class2 arg0, Client arg1) {
		...
		for ( int local22 = 0; local22 < 4; local22++) {
			byte[] local31 = arg0.method2(local20[local22], null);
			local36 = local31.length / 2;
			Class10_Sub1_Sub3 local42 = new Class10_Sub1_Sub3(true, local31);
		...
		for (local36 = 0; local36 < 4; local36++) {
			...
			Class10_Sub1_Sub3 local115 = new Class10_Sub1_Sub3(true, local104);
		...
		Class10_Sub1_Sub3 local193 = new Class10_Sub1_Sub3(true, local104);
