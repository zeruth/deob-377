...
public final class Class10_Sub1_Sub2_Sub4 extends Class10_Sub1_Sub2 {
	...
	public static void method269( byte[] arg0, int arg1) {
		try {
			if (arg0 == null) {
				...
				Class10_Sub1_Sub3 local31 = new Class10_Sub1_Sub3(true, arg0);
				local31.anInt428 = arg0.length - 18;
				Class27 local45 = aClass27Array1[arg1] = new Class27();
				local45.aByteArray11 = arg0;
				local45.anInt330 = local31.method313();
				local45.anInt331 = local31.method313();
				local45.anInt332 = local31.method311();
				int local63 = local31.method311();
				int local66 = local31.method311();
				int local69 = local31.method311();
				int local72 = local31.method311();
				int local75 = local31.method311();
				int local78 = local31.method313();
				int local81 = local31.method313();
				int local84 = local31.method313();
				int local87 = local31.method313();
				local45.anInt333 = 0;
	...
	private Class10_Sub1_Sub2_Sub4( int arg0, int arg1) {
		try {
			...
			Class10_Sub1_Sub3 local150 = new Class10_Sub1_Sub3(true, local32.aByteArray11);
			local150.anInt428 = local32.anInt333;
			Class10_Sub1_Sub3 local161 = new Class10_Sub1_Sub3(true, local32.aByteArray11);
			local161.anInt428 = local32.anInt334;
			Class10_Sub1_Sub3 local172 = new Class10_Sub1_Sub3(true, local32.aByteArray11);
			local172.anInt428 = local32.anInt335;
			Class10_Sub1_Sub3 local193 = new Class10_Sub1_Sub3(true, local32.aByteArray11);
			local193.anInt428 = local32.anInt336;
			Class10_Sub1_Sub3 local204 = new Class10_Sub1_Sub3(true, local32.aByteArray11);
			local204.anInt428 = local32.anInt337;
			int local210 = 0;
			int local212 = 0;
			int local214 = 0;
			int local221;
			...
			for ( int local216 = 0; local216 < this.anInt402; local216++) {
				...
				if (this.anIntArray129 != null) {
					this.anIntArray129[local216] = local204.method311();
				}
			}
			local150.anInt428 = local32.anInt340;
			local161.anInt428 = local32.anInt341;
			local172.anInt428 = local32.anInt342;
			local193.anInt428 = local32.anInt343;
			local204.anInt428 = local32.anInt344;
			for (local221 = 0; local221 < this.anInt403; local221++) {
				this.anIntArray125[local221] = local150.method313();
				if (this.anIntArray122 != null) {
					this.anIntArray122[local221] = local161.method311();
				}
				if (this.anIntArray123 != null) {
					this.anIntArray123[local221] = local172.method311();
				}
				if (this.anIntArray124 != null) {
					this.anIntArray124[local221] = local193.method311();
				}
				if (this.anIntArray130 != null) {
					this.anIntArray130[local221] = local204.method311();
				}
			}
			local150.anInt428 = local32.anInt338;
			local161.anInt428 = local32.anInt339;
			local223 = 0;
			local232 = 0;
			local241 = 0;
			int local385 = 0;
			...
			local150.anInt428 = local32.anInt345;
			for (local392 = 0; local392 < this.anInt405; local392++) {
				this.anIntArray126[local392] = local150.method313();
				this.anIntArray127[local392] = local150.method313();
				this.anIntArray128[local392] = local150.method313();
			}
