...
public final class Client extends GameShell {
	...
	private void method591( int arg0, byte arg1, Class10_Sub1_Sub3 arg2) {
		try {
			while (true) {
						...
						if (this.aBoolean216) {
							...
							if ((local13 == 13 || local13 == 10) && this.aString29.length() > 0) {
								...
								if (this.aString29.startsWith("::")) {
									...
									this.aClass10_Sub1_Sub3_7.method301(0);
									int local970 = this.aClass10_Sub1_Sub3_7.anInt428;
	...
	private boolean method608() {
		try {
			...
			try {
				...
				if (this.anInt844 == 82) {
					boolean local1535 = this.aClass10_Sub1_Sub3_9.method311() == 1;
	...
	private void method615( int arg0, Class10_Sub1_Sub3 arg1, int arg2) {
		try {
	...
	private void method616( int arg0, boolean arg1, Class10_Sub1_Sub3 arg2) {
		try {
	...
	private void method621( int arg0, Class10_Sub1_Sub3 arg1) {
		try {
	...
	private void method623( Class10_Sub1_Sub3 arg0, boolean arg1, int arg2) {
		try {
			this.aBoolean244 &= arg1;
			this.anInt1034 = 0;
			this.anInt885 = 0;
	...
	private void method630( int arg0, Class10_Sub1_Sub1_Sub1 arg1, int arg2) {
		try {
	...
	private Class2 method636( int arg0, String arg1, int arg2, int arg3, String arg4) {
		try {
			byte[] local3 = null;
			int local5 = 5;
			try {
			...
			while (local3 == null) {
				...
				try {
					...
					Class10_Sub1_Sub3 local102 = new Class10_Sub1_Sub3(true, local91);
					local102.anInt428 = 3;
					int local110 = local102.method315() + 6;
					int local112 = 6;
	...
	private void method637( Class10_Sub1_Sub3 arg0, int arg1, int arg2) {
		try {
			boolean local5 = false;
	...
	private void method638( int arg0, Class10_Sub1_Sub2_Sub3_Sub2 arg1, int arg2, Class10_Sub1_Sub3 arg3) {
		try {
			int local18;
			int local28;
			int local40;
			...
			if ((arg2 & 0x4) != 0) {
				...
				Class10_Sub1_Sub3 local282 = new Class10_Sub1_Sub3(true, local276);
	...
	protected void load() {
		...
		try {
			...
			this.method714(aBoolean250);
			this.method627();
			Class2 local203 = this.method636(this.anIntArray212[2], "config", 30, 2, "config");
			Class2 local215 = this.method636(this.anIntArray212[3], "interface", 35, 3, "interface");
			Class2 local227 = this.method636(this.anIntArray212[4], "media", 40, 4, "2d graphics");
			Class2 local239 = this.method636(this.anIntArray212[6], "textures", 45, 6, "textures");
			Class2 local251 = this.method636(this.anIntArray212[7], "wordenc", 50, 7, "chat system");
			Class2 local263 = this.method636(this.anIntArray212[8], "sounds", 55, 8, "sound effects");
	...
	private void method671( int arg0, int arg1, Class10_Sub1_Sub3 arg2) {
		try {
			this.anInt1034 = 0;
			this.anInt885 = 0;
	...
	private void method689( int arg0, Class10_Sub1_Sub3 arg1) {
		try {
	...
	private void method690( int arg0) {
		try {
			int[] local5 = this.aClass10_Sub1_Sub1_Sub1_11.anIntArray37;
	...
	private void method705( int arg0, Class10_Sub1_Sub1_Sub1 arg1, int arg2) {
		try {
			if (arg1 != null) {
	...
	private void method707( Class10_Sub1_Sub3 arg0, int arg1) {
		try {
			while (true) {
	...
	private void method708( Class10_Sub1_Sub3 arg0, int arg1) {
		try {
			int local12;
			int local15;
			int local19;
	...
	private void method714( boolean arg0) {
		try {
			byte[] local7 = this.aClass2_2.method2("title.dat", null);
			Class10_Sub1_Sub1_Sub1 local13 = new Class10_Sub1_Sub1_Sub1(local7, this);
			...
			int[] local98 = new int[local13.anInt104];
			int local104;
			for ( int local100 = 0; local100 < local13.anInt105; local100++) {
				...
				for ( int local130 = 0; local130 < local13.anInt104; local130++) {
					...
					if (local83.anInt120 == 0) {
						...
						if (local83.anInt120 == 2) {
								...
								for (local169 = 0; local169 < local83.anInt123; local169++) {
									...
									if (local83.anIntArray44[local163] > 0) {
										...
										if (local180 > Draw2D.anInt678 - 32 && local180 < Draw2D.anInt679 && local189 > Draw2D.anInt676 - 32 && local189 < Draw2D.anInt677 || this.anInt950 != 0 && this.anInt949 == local163) {
											...
											Class10_Sub1_Sub1_Sub1 local271 = Class17.method113(local247, local83.anIntArray40[local163], local222);
											if (local271 != null) {
												int local350;
										...
										Class10_Sub1_Sub1_Sub1 local539 = local83.aClass10_Sub1_Sub1_Sub1Array1[local163];
										if (local539 != null) {
							...
							if (local83.anInt120 == 4) {
								...
								Class10_Sub1_Sub1_Sub1 local1021;
								if (this.method670(local83)) {
	...
	private void method725( int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
		try {
			...
			if (local8 != 0) {
				...
				int[] local42 = this.aClass10_Sub1_Sub1_Sub1_11.anIntArray37;
			...
			if (local8 != 0) {
				...
				if (local451.anInt705 != -1) {
					...
					int[] local520 = this.aClass10_Sub1_Sub1_Sub1_11.anIntArray37;
				...
				if (this.anIntArray264[local8] <= 0) {
					...
					try {
						if (this.anIntArray251[local8] != this.anInt1024 || this.anIntArray275[local8] != this.anInt874) {
							Class10_Sub1_Sub3 local50 = Class39.method409(this.anIntArray275[local8], this.anIntArray251[local8]);
