...
public final class Class10_Sub1_Sub1_Sub2 extends Class10_Sub1_Sub1 {
	...
	public Class10_Sub1_Sub1_Sub2( boolean arg0, Class2 arg1, int arg2, String arg3) {
		try {
			Class10_Sub1_Sub3 local63 = new Class10_Sub1_Sub3(true, arg1.method2(arg3 + ".dat", null));
			Class10_Sub1_Sub3 local72 = new Class10_Sub1_Sub3(true, arg1.method2("index.dat", null));
			local72.anInt428 = local63.method313() + 4;
			int local95 = local72.method311();
			if (local95 > 0) {
			...
			for ( int local109 = 0; local109 < 256; local109++) {
				...
				int local133 = this.anIntArray58[local109] = local72.method313();
				int local141 = this.anIntArray59[local109] = local72.method313();
				int local144 = local72.method311();
